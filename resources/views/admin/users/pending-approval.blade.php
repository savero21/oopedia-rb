<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <!-- Tambahkan script untuk auto-refresh halaman setelah persetujuan -->
    <script>
    ...
    <script>
    // Tambahkan script ini di bagian bawah halaman pending.blade.php dan pending-approval.blade.php
