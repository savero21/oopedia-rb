    ...
    public function checkAnswer(Request $request)
{
    ...
    $explanation = null; // Hanya akan dikirim jika jawaban benar
    ...
    if ($question->question_type === 'fill_in_the_blank') {
        ...
        if ($correctAnswer) {
            ...
            // Hanya set explanation jika jawaban benar
            if ($isCorrect) {
    ...
    return response()->json([
        ...
        'explanation' => $isCorrect ? $explanation : null, // Hanya kirim jika benar
